...
export default function News() {
  ...
  return (<>
    ...
    {/* Bg Shapes */}
    <span className="block absolute left-0 top-0 w-full h-3/5 bg-whiter dark:bg-blacksection"></span>
    <img src="/images/shape/shape-09.svg" alt="Shape" className="animate-rotating absolute left-[10%] top-1/2" />
    <img src="/images/shape/shape-10.svg" alt="Shape" className="absolute left-[20%] top-[5%]" />
    <img src="/images/shape/shape-11.svg" alt="Shape" className="animate-rotating absolute right-[15%] top-[15%]" />

    {/* Section Title */}
    <SectionTitle title="Novice" text="Ostanite povezani z našimi najnovejšimi novicami in dogodki." />

    <div className="mx-auto max-w-1390 relative z-10 px-4 md:px-8 xl:px-26 mt-12.5 lg:mt-17.5">
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 lg:gap-12.5">
        {/* Team Item */}
        <div className="animate_top text-center">
          <div className="group relative overflow-hidden z-1">
            <img className="w-full" src="/images/team/team-01.png" alt="Team" />
            <div className="translate-y-25 group-hover:translate-y-0 ease-linear duration-300">
              <span className="absolute -left-5 -bottom-21 block w-[120%] h-37.5 bg-primary rotate-6 z-20"></span>
              <span className="absolute left-0 bottom-0 block w-full h-17 bg-secondary z-10"></span>
              <div className="absolute left-0 bottom-0 w-full pt-7.5 pb-5 z-30">
                <ul className="flex justify-center items-center gap-8">
                  <li>
                    <a href="#">
                      <svg
                        className="fill-white hover:fill-secondary ease-in-out duration-300"
                        width="10"
                        height="18"
                        viewBox="0 0 10 18"
                        fill="none"
          ...
          <h4 className="text-xl md:text-title-sm text-black dark:text-white mt-7.5 mb-1">
            Olivia Andrium
          </h4>
          <p>Product Manager</p>
        </div>
